...
* [Flask SQLAlchemy](https://www.youtube.com/watch?v=VVX7JIWx-ss&list=PLXmMXHVSvS-BlLA5beNJojJLlpE0PJgCW&index=4)
...
### [0. Get all states](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/0-select_states.py)
...
### [1. Filter states](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/1-filter_states.py)
...
### [2. Filter states by user input](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/2-my_filter_states.py)
...
### [3. SQL Injection...](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/3-my_safe_filter_states.py)
...
### [4. Cities by states](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/4-cities_by_state.py)
...
### [5. All cities by state](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/5-filter_cities.py)
...
```
guillaume@ubuntu:~/$ cat 4-cities_by_stathttps://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/image1.jpg?raw=truee.sql
-- Create states table in hbtn_0e_4_usa with some data
CREATE DATABASE IF NOT EXISTS hbtn_0e_4_usa;
USE hbtn_0e_4_usa;
CREATE TABLE IF NOT EXISTS states (
...
### [6. First state model](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/model_state.py)

![](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/image1.jpg?raw=true)
...
### [7. All states via SQLAlchemy](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/7-model_state_fetch_all.py)
...
### [8. First state](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/8-model_state_fetch_first.py)
...
### [9. Contains `a`](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/9-model_state_filter_a.py)
...
### [10. Get a state](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/10-model_state_my_get.py)
...
### [12. Update a state](https://github.com/luciel53/holbertonschool-higher_level_programming/blob/main/python-object_relational_mapping/12-model_state_update_id_2.py)
